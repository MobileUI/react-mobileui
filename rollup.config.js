...
libConfig.targets = [
  { dest: 'dist/react-mobileui.cjs.js', format: 'cjs' },
  { dest: 'dist/react-mobileui.es.js', format: 'es' },
];
...
umdFullConfig.targets = [
  { dest: 'dist/react-mobileui.full.js', format: 'umd' },
];
...
umdFullConfigMin.targets = [
  { dest: 'dist/react-mobileui.full.min.js', format: 'umd' },
];
...
umdConfig.targets = [
  { dest: 'dist/react-mobileui.js', format: 'umd' },
];
...
umdConfigMin.targets = [
  { dest: 'dist/react-mobileui.min.js', format: 'umd' },
];
